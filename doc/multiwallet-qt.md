...
In order to support loading of multiple wallets in cmpco-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cmpco.cpp.
...
Changes to cmpco.cpp
----------------------
cmpco.cpp is the entry point into cmpco-qt, and as such, will require some minor modifications to provide hooks for
