...
RESOURCES += src/qt/cmpco.qrc src/qt/cmpco_locale.qrc

TRANSLATIONS += src/qt/locale/cmpco_bg.ts \
                src/qt/locale/cmpco_de.ts \
                src/qt/locale/cmpco_en.ts \
                src/qt/locale/cmpco_es.ts \
                src/qt/locale/cmpco_fi.ts \
                src/qt/locale/cmpco_fr.ts \
                src/qt/locale/cmpco_it.ts \
                src/qt/locale/cmpco_ja.ts \
                src/qt/locale/cmpco_pl.ts \
                src/qt/locale/cmpco_pt.ts \
                src/qt/locale/cmpco_ru.ts \
                src/qt/locale/cmpco_sk.ts \
                src/qt/locale/cmpco_sv.ts \
                src/qt/locale/cmpco_vi.ts \
                src/qt/locale/cmpco_zh_CN.ts \
                src/qt/locale/cmpco_zh_TW.ts
