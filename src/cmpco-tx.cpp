...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CMPCO Core cmpco-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cmpco-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cmpco transaction") + "\n" +
                               "  cmpco-tx [options] -create [commands]   " + _("Create hex-encoded cmpco transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cmpco transaction
