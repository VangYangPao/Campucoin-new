...
/** Utility functions used by the CMPCO Qt UI.
 */
namespace GUIUtil
{
...
// Render CMPCO addresses in monospace font
...
// Parse "cmpco:" URI into recipient object, return true on successful parsing
