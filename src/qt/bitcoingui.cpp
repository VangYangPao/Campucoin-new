                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CMPCO-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CMPCO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cmpco: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CMPCO Core"), this);
    aboutAction->setStatusTip(tr("Show information about CMPCO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CMPCO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CMPCO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CMPCO addresses"));
    ...
    openAction->setStatusTip(tr("Open a CMPCO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CMPCO Core help message to get a list with possible CMPCO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CMPCO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CMPCO network", "", count));
}
...
{
    QString strTitle = tr("CMPCO Core"); // default title
