...
#if defined(NDEBUG)
#error "CMPCO cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "CMPCO Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if(nHeight <= 5700 && nHeight > 0) {
		...
		nSubsidy = 12150 * COIN; // compensate to 54 MN owners each 225 CMPCO(reward for stop time)
