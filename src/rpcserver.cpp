...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CMPCO features */
        {"cmpco", "masternode", &masternode, true, true, false},
        {"cmpco", "masternodelist", &masternodelist, true, true, false},
        {"cmpco", "mnbudget", &mnbudget, true, true, false},
        {"cmpco", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"cmpco", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cmpco", "mnsync", &mnsync, true, true, false},
        {"cmpco", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cmpcod, or the -server option to cmpco-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cmpco-cli " + methodname + " " + args + "\n";
}
